...
public class MotionProfileGoal {
    ...
    public boolean atGoalState(MotionProfilePoint state) {
        return atGoalPos(state.getPosition()) && (Math.abs(state.getVelocity()) < (max_abs_vel + vel_tolerance)
    ...
    public boolean equals(Object obj) {
        ...
        return (other.completion_behavior() == completion_behavior()) && (other.getPosition() == getPosition())
                && (other.getMaxVel() == getMaxVel()) && (other.getPositionTolerance() == getPositionTolerance())
                && (other.getVelocityTolerance() == getVelocityTolerance());
    }
}
